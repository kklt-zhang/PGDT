_base_ = [
    ...
    '../_base_/datasets/semi_ssdd_detection.py'  # Use the cleaned dataset file name
]
...
unlabeled_dataset.data_prefix = dict(img='images/train/')

train_dataloader = dict(
    dataset=dict(datasets=[labeled_dataset, unlabeled_dataset]))

# Training schedule for SSDD
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=20000, val_interval=186)
...
param_scheduler = [
    ...
    dict(type='MultiStepLR', begin=0, end=20000, by_epoch=False, milestones=[16000, 19000], gamma=0.1)
]
